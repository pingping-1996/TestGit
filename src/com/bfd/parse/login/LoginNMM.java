...
//            String html = chinaPosrSloginnew1(ip);
//            String d = Jsoup.parse(html).select("script").html();
//            LOG.info("mmbactioncookied++++1=" + d);
...
//            html = createCookie(str, "wy", 9000000 + "", ".mmbang.com");
            ...
            date.setTime(d);
            String result = "__9XRwuHhHTjQiC8wXCnCj7wsEBU9x=wy; expires="+date.toGMTString()+"; path=/; domain=.mmbang.com";
...
//		 	 }
    ...
    public static void main(String[] args) throws Exception {
        ...
        String html = createCookie(str, "wy", 9000000 + "", ".mmbang.com");
...
//		get.setConfig(requestConfig);
    ...
    private static String createCookie(String name, String value, String days, String domain) throws Exception {
        ...
        String result = (String) inv.invokeFunction("createCookie", name, value, days, domain);
        return result;
    }
}
